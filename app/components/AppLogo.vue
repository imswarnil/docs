<template>
<svg viewBox="0 0 1600 200" xmlns="http://www.w3.org/2000/svg" fill="none" role="img" aria-label="CRM Analytics Academy" class="w-auto h-[var(--logo-h,1.75rem)] shrink-0" style="height: var(--logo-h, 1.75rem);" preserveAspectRatio="xMinYMid meet">
